...
export const URLComics = 'https://gateway.marvel.com:443/v1/public/characters/';
export const URLEvents = 'https://gateway.marvel.com:443/v1/public/characters/';
...
export default { BaseURL, publicKey, privateKey, timestamp, hash, URLComics, URLEvents};